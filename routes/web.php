...
Route::get('/blogs/new','Site\BlogsController@newBlog')->name('blog.new')->middleware('auth');
...
Route::get('/blog/{slug}/edit','Site\BlogsController@editBlog')->name('blog.edit')->middleware('auth');
Route::get('/member/{roll_id}','Site\ProfileController@profile')->name('user.profile');
Route::get('/member/{roll_id}/edit','Site\ProfileController@edit_profile')->name('user.profile.edit')->middleware('auth');
Route::get('/member/add/portfolio','Site\ProfileController@showAddPortfolio')->name('user.profile.add.portfolio')->middleware('auth');
Route::get('/member/edit/portfolio/{id}','Site\ProfileController@showEditPortfolio')->name('user.profile.edit.portfolio')->middleware('auth');
Route::get('/member/{id}/settings','Site\ProfileController@showSettings')->name('user.profile.settings')->middleware('auth');
